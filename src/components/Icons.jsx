...
export function GridIcon({ className = "size-4" }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className={className} aria-hidden="true">
...
export function RadarIcon({ className = "size-4" }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className={className} aria-hidden="true">
      <path d="M19.07 4.93A10 10 0 0 0 7 3.34" />
      <path d="M2.29 9.62A10 10 0 1 0 21.31 8.35" />
      <path d="M16.24 7.76A6 6 0 1 0 8.23 16.67" />
      <circle cx="12" cy="12" r="2" />
      <path d="m13.4 10.6 5.7-5.7" />
    </svg>
  );
}
...
export function SparklesIcon({ className = "size-4" }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className={className} aria-hidden="true">
      <path d="m12 3 1.4 4.6a2 2 0 0 0 1.3 1.3L19.3 10 14.7 11.4a2 2 0 0 0-1.3 1.3L12 17.3l-1.4-4.6a2 2 0 0 0-1.3-1.3L4.7 10l4.6-1.4a2 2 0 0 0 1.3-1.3Z" />
      <path d="M20 2v4" />
      <path d="M22 4h-4" />
...
export function UsersIcon({ className = "size-4" }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className={className} aria-hidden="true">
...
export function FunnelIcon({ className = "size-4" }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className={className} aria-hidden="true">
...
export function InboxIcon({ className = "size-4" }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className={className} aria-hidden="true">
...
export function UploadIcon({ className = "size-4" }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className={className} aria-hidden="true">
      <path d="M12 16V4" />
      <path d="m7 9 5-5 5 5" />
...
export function PhoneIcon({ className = "size-4" }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className={className} aria-hidden="true">
      <path d="M22 16.9v3a2 2 0 0 1-2.2 2A19.8 19.8 0 0 1 2.1 4.2 2 2 0 0 1 4.1 2h3a2 2 0 0 1 2 1.7l.4 3a2 2 0 0 1-.6 1.8l-1.3 1.3a16 16 0 0 0 6.5 6.5l1.3-1.3a2 2 0 0 1 1.8-.6l3 .4a2 2 0 0 1 1.7 2Z" />
    </svg>
  );
}
...
export function NoteIcon({ className = "size-4" }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className={className} aria-hidden="true">
...
export function EyeOffIcon({ className = "size-4" }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" className={className} aria-hidden="true">
      <path d="M17.94 17.94A10.94 10.94 0 0 1 12 20c-7 0-11-8-11-8a20.3 20.3 0 0 1 4.22-5.65M9.9 4.24A10.94 10.94 0 0 1 12 4c7 0 11 8 11 8a20.3 20.3 0 0 1-2.16 3.19M14.12 14.12a3 3 0 1 1-4.24-4.24" />
      <path d="M1 1l22 22" />
    </svg>
  );
}

export function AttachmentIcon({ className = "size-4" }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className={className} aria-hidden="true">
      <path d="m21.4 11-8.5 8.5a6 6 0 0 1-8.5-8.5L13.6 1.8a4 4 0 0 1 5.7 5.7L10 16.8a2 2 0 0 1-2.8-2.8l8.5-8.5" />
    </svg>
  );
}

export function ChartBarIcon({ className = "size-4" }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className={className} aria-hidden="true">
      <path d="M3 21h18" />
      <rect x="5" y="12" width="3.2" height="9" rx="1" />
      <rect x="10.4" y="7" width="3.2" height="14" rx="1" />
      <rect x="15.8" y="4" width="3.2" height="17" rx="1" />
    </svg>
  );
}

export function ChatBubbleIcon({ className = "size-4" }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className={className} aria-hidden="true">
...
export function MegaphoneIcon({ className = "size-4" }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className={className} aria-hidden="true">
      <path d="m3 11 18-6v14L3 13Z" />
      <path d="M3 11v2a2 2 0 0 0 2 2h1v4a1 1 0 0 0 1 1h1.5" />
    </svg>
  );
}

export function DropletIcon({ className = "size-4" }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className={className} aria-hidden="true">
      <path d="M12 2.7s6.5 7.1 6.5 11.8a6.5 6.5 0 1 1-13 0C5.5 9.8 12 2.7 12 2.7Z" />
    </svg>
  );
}

export function ZapIcon({ className = "size-4" }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className={className} aria-hidden="true">
...
export function WorkflowIcon({ className = "size-4" }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className={className} aria-hidden="true">
      <rect x="3" y="3" width="7" height="6" rx="1.5" />
      <rect x="14" y="3" width="7" height="6" rx="1.5" />
      <rect x="8.5" y="15" width="7" height="6" rx="1.5" />
      <path d="M6.5 9v3a2 2 0 0 0 2 2H12" />
      <path d="M17.5 9v3a2 2 0 0 1-2 2H12" />
      <path d="M12 14v1" />
    </svg>
  );
}

export function LinkIcon({ className = "size-4" }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className={className} aria-hidden="true">
...
export function CogIcon({ className = "size-4" }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className={className} aria-hidden="true">
      <circle cx="12" cy="12" r="3" />
...
export function CheckCircleIcon({ className = "size-4" }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className={className} aria-hidden="true">
...
export function VideoIcon({ className = "size-4" }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className={className} aria-hidden="true">
      <rect x="2" y="6" width="14" height="12" rx="2" />
      <path d="m16 10 5.5-3.5a1 1 0 0 1 1.5.86v9.28a1 1 0 0 1-1.5.86L16 14" />
    </svg>
  );
}
...
export function DatabaseIcon({ className = "size-4" }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className={className} aria-hidden="true">
