...
export function OutreachDoeModule() {
  ...
  const cards = useMemo(
    () => [
      { label: "Emails Sent", value: fmtNum(data?.top.emailsSent), note: "Actual provider sends", noteTone: "blue" },
      ...
      { label: "Response Rate", value: fmtPct(data?.top.responseRate), note: "Responses / Emails Sent", noteTone: "violet" }
    ],
    [data]
  );
