...
const KPI_ROWS = [
  ...
  { key: "zoomConversion", label: "Zoom Conversion", formula: "Calls completed / Calls scheduled", format: fmtPct },
  { key: "dataRoomCompletion", label: "Data Room Completion", formula: "Required categories uploaded / Required categories", format: fmtPct },
  { key: "ioiConversion", label: "IOI Conversion", formula: "IOIs signed / IOIs generated", format: fmtPct },
  { key: "fieldVisitCompletion", label: "Field Visit", formula: "Visits completed / Visits planned", format: fmtPct },
  { key: "termSheetConversion", label: "Term Sheet Conversion", formula: "Term sheets issued / Leads reaching field visit", format: fmtPct },
